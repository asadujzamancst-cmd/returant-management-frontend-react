...
const OrderDeliver = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://softworktech.com/asad_ecom/api/orders-deliverd/', {
      headers: {
    ...
    <AdminLayout>
      <div className="p-4 shadow-sm rounded">
        <h1 className="text-primary">
          <i className="fas fa-list-alt me-1"></i> Detail of order Delevired
        </h1>

        <h5 className='text-end text-muted'>
          <i className='fas fa-database me-1'></i> total delevired
